...
public class SignupOne extends JFrame implements ActionListener{
    ...
    long random;
    JTextField nameTextField,fnameTextField,addressTextField, emailTextField, cityTextField,stateTextField, pinTextField,dobTextField ;
    JButton next;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                Conn c = new Conn();
                String query = "insert into signup values('"+formno+"','"+name+"','"+fname+"', '"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+state+"','"+pin+"')";  //Data Inserting in MySql
